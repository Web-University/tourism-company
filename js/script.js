window.addEventListener('DOMContentLoaded', () => {
    ...
    //document.querySelector("#catalog").onclick = loadRegions
    loadRegions()
    loadMainCaroucel()
    loadCatalog();
            ...
            GET("db/regions/regions.json", "json").then(Jregions => {
                Jregions.forEach(i => {  
                    ...
                    GET(`db/regions/${i.shortnameRegion}/places.json`, "json").then(places => {
                        ...
                        Region = insertProperty(Region, "flex-row-reverse", i.id % 2 == 0 ? "flex-row-reverse" : "")  
            ...
            GET("inserts/main-carousel-item.html", "text").then(main_carousel_item => {
                ...
                GET(`${str}/places.json`, "json").then(places => {
                    ...
                    document.querySelector("#descriptionText").innerHTML =
                        `<h2>${places.find((i => i.shortname == str2)).description}</h2>`
